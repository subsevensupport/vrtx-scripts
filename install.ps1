# =====================================================================
# Vortex Drive Mapper - Auto Installer
# Downloads and installs from GitHub
# =====================================================================

Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "     Vortex Drive Mapper - Installing from GitHub..." -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""

# Configuration
$targetDir = "C:\scripts"
$repoUrl = "https://raw.githubusercontent.com/YOURUSERNAME/VortexDriveMapper/main"
